        ...
        <footer className="border-t border-white/10 bg-black pt-24 pb-12 relative overflow-hidden">
            ...
            <div className="max-w-7xl mx-auto px-6 md:px-12 lg:px-24 relative z-10">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-16 mb-20">
                    <div className="max-w-xl">
                        ...
                        <div className="flex gap-4">
                            <a href="#" className="h-12 w-12 rounded-full bg-white/5 border border-white/10 flex items-center justify-center hover:bg-white hover:text-black transition-all duration-300 text-white group">
                ...
                <div className="pt-8 border-t border-white/10 flex flex-col md:flex-row justify-between text-sm text-white/40 items-center gap-6">
                    <p>© {new Date().getFullYear()} Yak Media. All rights reserved.</p>
